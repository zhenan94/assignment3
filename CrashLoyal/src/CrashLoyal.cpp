...
void drawBuilding(std::shared_ptr<Building> b) {
	...
	float centerX = b->getPoint().x * PIXELS_PER_METER;
	float centerY = b->getPoint().y * PIXELS_PER_METER;
	float squareSize = b->GetSize()  * PIXELS_PER_METER;
...
void drawMob(std::shared_ptr<Mob> m) {
	...
	//change the draw part to the same way to draw buildings.
...
void drawBG() {
	...
	// Draw bridges
	//change the draw part to the same way to draw mobs and buildings.
	SDL_Rect bridgeLeft = {
		(int)(LEFT_BRIDGE_CENTER_X  * PIXELS_PER_METER - (BRIDGE_WIDTH * PIXELS_PER_METER / 2.f)),
		(int)(LEFT_BRIDGE_CENTER_Y  * PIXELS_PER_METER- (BRIDGE_HEIGHT * PIXELS_PER_METER / 2.f)),
	...
	SDL_Rect bridgeRight = {
		(int)(RIGHT_BRIDGE_CENTER_X * PIXELS_PER_METER - (BRIDGE_WIDTH * PIXELS_PER_METER / 2.f)),
		(int)(RIGHT_BRIDGE_CENTER_Y * PIXELS_PER_METER - (BRIDGE_HEIGHT * PIXELS_PER_METER / 2.f)),
		(int)(BRIDGE_WIDTH * PIXELS_PER_METER),
		(int)(BRIDGE_HEIGHT * PIXELS_PER_METER)
	};
	SDL_SetRenderDrawColor(gRenderer, 179, 59, 0, 0xFF); // Brown
